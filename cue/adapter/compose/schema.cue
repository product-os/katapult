...
#Compose: {
	...
	// Removed the following list.UniqueItems() constraint due to the following error
	// Error: composes."open-balena".services."open-balena-registry".depends_on: invalid value ["open-blanea-s3","redis"] (does not satisfy list.UniqueItems)
