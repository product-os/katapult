...
import (    
    "github.com/product-os/katapult/cue/openbalena"
)

contracts: openbalena.contracts
blueprints: openbalena.blueprints
distribution: openbalena.distribution

contracts: {
	"open-balena-api": {
		config: {
			API_VPN_SERVICE_API_KEY: {
				value: crypto.key(input.SEED)
			}
			BALENA_ROOT_CA: {
