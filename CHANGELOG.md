...
* Apply cue fmt [Thomas Manning]
* Update compose to omit empty values [Thomas Manning]
* Update compose to use functions [Thomas Manning]
* Add environment contracts and blueprints [Thomas Manning]
* Add cue for openBalena and compose [Thomas Manning]
* Describe katapult implementation [Roman Mazur]
* Adjust for the new CUE version [Roman Mazur]
* Add package-lock support [Roman Mazur]
* Split into packages [Roman Mazur]
* Add simple deployments implementation [Roman Mazur]
* Format cue files [Roman Mazur]
* Resolve namespaces and ports [Roman Mazur]
* Add k8s spec generation with CUE [Roman Mazur]
...
* ✨: Introducing template generators [Andreas Fitzek]
